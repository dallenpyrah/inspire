...
class ToDoService{
    ...
    async getToDo(){
        try {
            const res = await sandApi.get('dallen/todos')
    ...
    async createTask(rawToDo){
        try {
            const res = await sandApi.post('dallen/todos', rawToDo)
            this.getToDo();
            console.log(res)
        } catch (error) {
            console.error(error)
    ...
    async markComplete(id){
        ...
        try {
            const res = await sandApi.put('dallen/todos/' + id, task)
            this.getToDo();
            console.log(res)
        } catch (error) {
            console.error(error)
    ...
    async deleteTask(id){
        try {
            const res = await sandApi.delete('dallen/todos/' + id)
            this.getToDo();
            console.log(res)
        } catch (error) {
            console.error(error)
